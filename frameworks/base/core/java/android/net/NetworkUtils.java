...
import android.net.cells.IcellsNetworkUtils;
import android.net.cells.cellsNetworkUtils;
...
public class NetworkUtils {
    ...
    static class VMcellsNetworkUtils implements DeathRecipient {
        @Override
        public void binderDied() {
            Log.e(TAG,"host NET.cellsNetworkUtils is Died ");
            mcellsNetworkUtils = null;
        }
    }

    private static IcellsNetworkUtils mcellsNetworkUtils;
    private static void createcellsNetworkUtils(){
        final Object mLock = new Object();
        synchronized(mLock){
            if(mcellsNetworkUtils != null) return ;

            if(SystemProperties.get("ro.boot.vm","0").equals("0")){
                cellsNetworkUtils networkUtils = new cellsNetworkUtils();
                ServiceManager.addService("NET.cellsNetworkUtils", networkUtils);
                mcellsNetworkUtils = networkUtils;
            }else{
                int count = 10;
                do{
                    SystemClock.sleep(500);
                    mcellsNetworkUtils = IcellsNetworkUtils.Stub.asInterface(ServiceManager.getInitService("NET.cellsNetworkUtils"));
                }while(count-->0 && mcellsNetworkUtils == null);

                Log.d(TAG,"get NET.cellsNetworkUtils " + mcellsNetworkUtils);
                if(mcellsNetworkUtils != null){
                    try{
                        mcellsNetworkUtils.asBinder().linkToDeath(new VMcellsNetworkUtils(), 0);
                    } catch (RemoteException e) {
                        Log.e(TAG,"Not linkToDeath " + e);
                    }
                }
            }
        }
    ...
    public static int resetConnections(String interfaceName, int mask){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return -1;
            return mcellsNetworkUtils.doResetConnections(interfaceName,mask);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
     ...
     */
    public static boolean startDhcp(String interfaceName){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doStartDhcp(interfaceName);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
     ...
     * @return {@code true} for success, {@code false} for failure
     */
    public static boolean startDhcpRenew(String interfaceName){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doStartDhcpRenew(interfaceName);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
     ...
     * @return {@code true} for success, {@code false} for failure
     */
    public static boolean getDhcpResults(String interfaceName, DhcpResults dhcpResults){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doGetDhcpResults(interfaceName,dhcpResults);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static boolean stopDhcp(String interfaceName){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doStopDhcp(interfaceName);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static boolean releaseDhcpLease(String interfaceName){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doReleaseDhcpLease(interfaceName);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static String getDhcpError(){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return null;
            return mcellsNetworkUtils.doGetDhcpError();
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static void attachDhcpFilter(FileDescriptor fd) throws SocketException{
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return ;
            mcellsNetworkUtils.doAttachDhcpFilter(new ParcelFileDescriptor(fd));
        } catch (RemoteException e) {
            throw new SocketException("attachDhcpFilter");
        }
    }
    ...
    public static boolean bindProcessToNetwork(int netId){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doBindProcessToNetwork(netId);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static int getBoundNetworkForProcess(){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return 0;
            return mcellsNetworkUtils.doGetBoundNetworkForProcess();
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static boolean bindProcessToNetworkForHostResolution(int netId){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doBindProcessToNetworkForHostResolution(netId);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
     ...
     */
    public static int bindSocketToNetwork(int socketfd, int netId){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return -1;
            return mcellsNetworkUtils.doBindSocketToNetwork(socketfd,netId);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static boolean protectFromVpn(int socketfd){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doProtectFromVpn(socketfd);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
    ...
    public static boolean queryUserAccess(int uid, int netId){
        try {
            createcellsNetworkUtils();
            if(mcellsNetworkUtils == null) return false;
            return mcellsNetworkUtils.doQueryUserAccess(uid,netId);
        } catch (RemoteException e) {
            Log.e(TAG,"e="+e);
        }
