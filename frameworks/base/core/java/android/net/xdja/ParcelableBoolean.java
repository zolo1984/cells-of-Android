...
public class ParcelableBoolean implements Parcelable {
    ...
    public ParcelableBoolean(boolean v){
        this.v = v;
    }
    ...
    public static final Parcelable.Creator<ParcelableBoolean> CREATOR =
            new Parcelable.Creator<ParcelableBoolean>() {
                @Override
                public ParcelableBoolean createFromParcel(Parcel in) {
                    return new ParcelableBoolean(in.readInt() == 1?true:false);
                }
                @Override
