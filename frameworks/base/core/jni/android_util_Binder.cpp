...
static jint android_os_Binder_getCallingSystemMode(JNIEnv* env, jobject clazz)
{
    return IPCThreadState::self()->getCallingSystemMode();
}
...
static const JNINativeMethod gBinderMethods[] = {
    ...
    { "getCallingSystemMode", "()I", (void*)android_os_Binder_getCallingSystemMode },
...
static jobject android_os_BinderInternal_getInitContextObject(JNIEnv* env, jobject clazz)
{
    ALOGE("initservicemanager android_os_BinderInternal_getInitContextObject \n");
    sp<IBinder> b = ProcessState::self()->getInitContextObject(NULL);
    return javaObjectForIBinder(env, b);
}
...
static const JNINativeMethod gBinderInternalMethods[] = {
    ...
    { "getInitContextObject", "()Landroid/os/IBinder;", (void*)android_os_BinderInternal_getInitContextObject },
