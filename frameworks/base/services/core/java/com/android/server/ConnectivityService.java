        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case NetworkAgent.EVENT_NETWORK_SCORE_CHANGED: {
                    ...
                    ParcelableInt score = (ParcelableInt) msg.obj;
                    if (score != null) updateNetworkScore(nai, score.getResult());
                    break;
                }
                case NetworkAgent.EVENT_UID_RANGES_ADDED: {
                    ...
                    try {
                        mNetd.addVpnUidRanges(nai.network.netId, ((ParcelableArrayUidRange)msg.obj).mResults);
                    } catch (Exception e) {
                        // Never crash!
                ...
                case NetworkAgent.EVENT_UID_RANGES_REMOVED: {
                    ...
                    try {
                        mNetd.removeVpnUidRanges(nai.network.netId, ((ParcelableArrayUidRange)msg.obj).mResults);
                    } catch (Exception e) {
                        // Never crash!
                ...
                case NetworkAgent.EVENT_SET_EXPLICITLY_SELECTED: {
                    ...
                    nai.networkMisc.acceptUnvalidated = ((ParcelableBoolean) msg.obj).getResult();
                    break;
                }
                ...
                case NetworkMonitor.EVENT_NETWORK_TESTED: {
                    ...
                    if (isLiveNetworkAgent(nai, "EVENT_NETWORK_TESTED")) {
                        ...
                        if (DBG) log(nai.name() + " 1validation " + (valid ? " passed" : "failed"));
