...
public class Tethering extends BaseNetworkObserver {
    ...
    private static final String USB_NEAR_IFACE_ADDR      = "172.17.3.2";
    private static final int USB_PREFIX_LENGTH        = 16;
    ...
    private void tetherUsb(boolean enable) {
        ...
        for (String iface : ifaces) {
            if (isUsb(iface)) {
                int result = (enable ? tether(iface) : untether(""));
                ...
                switch (message.what) {
                    ...
                    case CMD_TETHER_CONNECTION_CHANGED:
                        ...
                        if (newUpstreamIfaceName != null) {
                            try {
                                Log.d(TAG, "jl mIfaceName=" + mIfaceName + " newUpstreamIfaceName="+newUpstreamIfaceName);
