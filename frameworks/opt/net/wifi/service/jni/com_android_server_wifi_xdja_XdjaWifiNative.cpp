...
static jboolean android_net_wifi_startScan(
    ...
    const char *bucket_array_type = "[Lcom/android/server/wifi/cells/BucketSettings;";
    const char *channel_array_type = "[Lcom/android/server/wifi/cells/ChannelSettings;";
...
static jobject android_net_wifi_get_tdls_status(JNIEnv *env,jclass cls, jint iface,jstring addr) {
    ...
    if (ret != WIFI_SUCCESS) {
        ...
        JNIObject<jobject> tdls_status = helper.createObject(
                "com/android/server/wifi/cells/TdlsStatus");
...
static jobject android_net_wifi_get_tdls_capabilities(JNIEnv *env, jclass cls, jint iface) {
    ...
    if (WIFI_SUCCESS == ret) {
         JNIObject<jobject> capabilities = helper.createObject(
                 "com/android/server/wifi/cells/TdlsCapabilities");
...
static jobject android_net_wifi_get_ring_buffer_status (JNIEnv *env, jclass cls, jint iface) {
    ...
    if (result == WIFI_SUCCESS) {
        ...
        JNIObject<jobjectArray> ringBuffersStatus = helper.newObjectArray(
            num_rings, "com/android/server/wifi/cells/RingBufferStatus", NULL);
        ...
        for(u32 i = 0; i < num_rings; i++, tmp++) {
            ...
            JNIObject<jobject> ringStatus = helper.createObject(
                    "com/android/server/wifi/cells/RingBufferStatus");
...
static void on_ring_buffer_data(char *ring_name, char *buffer, int buffer_size,
    ...
    helper.reportEvent(mCls,"onRingBufferData",
            "(Lcom/android/server/wifi/cells/RingBufferStatus;[B)V",
...
static JNINativeMethod gWifiMethods[] = {
    ...
    { "getScanCapabilitiesNative", "(ILcom/android/server/wifi/cells/ScanCapabilities;)Z",
            (void *) android_net_wifi_getScanCapabilities},
    { "startScanNative", "(IILcom/android/server/wifi/cells/ScanSettings;)Z",
    ...
    { "setPnoListNative", "(II[Lcom/android/server/wifi/cells/WifiPnoNetwork;)Z",
    ...
    {"getTdlsStatusNative", "(ILjava/lang/String;)Lcom/android/server/wifi/cells/TdlsStatus;",
            (void*) android_net_wifi_get_tdls_status},
    {"getTdlsCapabilitiesNative", "(I)Lcom/android/server/wifi/cells/TdlsCapabilities;",
    ...
    {"getRingBufferStatusNative", "(I)[Lcom/android/server/wifi/cells/RingBufferStatus;",
    ...
    { "setLazyRoamNative", "(IIZLcom/android/server/wifi/cells/WifiLazyRoamParams;)Z",
...
int register_android_net_wifi_cells_cellsWifiNative(JNIEnv* env) {
    return AndroidRuntime::registerNativeMethods(env,
            "com/android/server/wifi/cells/cellsWifiNative", gWifiMethods, NELEM(gWifiMethods));
}

/* User to register native functions */
extern "C"
jint Java_com_android_server_wifi_cells_cellsWifiNative_registerNatives(JNIEnv* env, jclass clazz) {
    return AndroidRuntime::registerNativeMethods(env,
            "com/android/server/wifi/cells/cellsWifiNative", gWifiMethods, NELEM(gWifiMethods));
}
