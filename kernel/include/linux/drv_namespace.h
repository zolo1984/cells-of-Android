...
#define DRV_NS_TAG_LEN 16
#define DRV_NS_DESC_MAX 32
#define INIT_DRV_NS_IDX 0
#define CELLS_SYSTEM_NUM	2
#define MAX_CONTAINER	8
#define SECURITY_SYSTEM_TAG	"cell1"
#define GENERAL_SYSTEM_TAG	"cell2"
#define SECURITY_SYSTEM_MODE	1
#define GENERAL_SYSTEM_MODE		0
...
extern struct pid_namespace *sys_mode_to_pid_ns[CELLS_SYSTEM_NUM];
#ifdef CONFIG_DRV_NS
...
extern void get_drv_ns_tag(char *to, struct drv_namespace *drv);
...
static inline void get_drv_ns_tag(char *to, struct drv_namespace *drv_ns)
{
	strcpy(to, "");
}
