...
class IFingerprintDaemon : public IInterface, public IBinder::DeathRecipient {
    public:
        enum {
           ...
           INIT2 = IBinder::FIRST_CALL_TRANSACTION + 11,
           POST_ENROLL = IBinder::FIRST_CALL_TRANSACTION + 12,
        };
        ...
        virtual void init2(const sp<IFingerprintDaemonCallback>& callback,int sysid) = 0;
